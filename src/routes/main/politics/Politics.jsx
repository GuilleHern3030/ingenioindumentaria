        ...
        {dataLoaded && <main className={`unselectable`}>
            <div style={{margin:'1em'}}>
                <div>
                    ...
                    <p>El usuario que facilitara sus datos personales, autoriza expresamente a {pageName} para el uso de los datos aportados con los fines aquí expuestos. Implica ello además la aceptación de todos los términos contenidos en esta Política, y en los <span className='cursor' style={{color:'blue'}} onClick={handleLink}>Términos y Condiciones Generales</span>.</p>
