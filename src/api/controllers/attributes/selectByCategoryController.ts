...
const endpoint = "/attributes/category";

/**
 * Get attributes in JSON format
 * @returns Promise with a JSON of attributes
 */
const selectByCategory = async(slug:string, includeDisabled:boolean) => {
    ...
    devConsole(`attributes.selectCategory(includeDisabled:${includeDisabled}, ${slug})`, data)
