export { default as remove } from "./handlers/articles/deleteArticleHandler.ts";
...
import { post as postArticle, put as putArticle, remove as removeArticle } from './articles.ts'
